...
export function Button({ item, getbtnValue, isCorrect, btnValue, currentQuestion }){
    ...
    <>
        {
             Object.entries(item).map(([props, opt],index) => {
               ...
               if(btnValue === opt && 
                ...
                )}else /* if(btnValue !== opt && btnValue !== currentQuestion && btnValue !== null) */{
                    return ( 
                <div>
                    <ButtonView 
