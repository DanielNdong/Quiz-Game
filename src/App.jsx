...
export default function App() {
  ...
  return (
    <Fragment>
      <Cards numQuest={numQuest} getSetNumQuest={getSetNumQuest} questions={questions} getCurrentQuestion={getCurrentQuestion}/>
      <Options numQuest={numQuest} item={responses} btnValue={btnValue} currentQuestion={currentQuestion} responses={respons} isCorrect={isCorrect} getbtnValue={getbtnValue}/>
